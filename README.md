...
# Features
- User can search for available flights, buses, ferries and hotels, by giving his source from, and destination to, which he wants to travel.  
- User can book tickets for trains, buses , flights and hotels online.
- User can see his previous bookings, and cancel them, as needed.
- User can see suggestions, available tickets and other available services, so that he/she can book accordingly.      
# Technologies Used
# Frontend
- HTML
- CSS
